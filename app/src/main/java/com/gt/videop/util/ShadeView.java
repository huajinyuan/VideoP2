...
public class ShadeView extends View {
     ...
     * 图标默认背景色
     */
    private final int DEFAULT_ICON_BACKGROUND_COLOR = 0xfd6d32;
    /**
     * 图标底部文本
     */
    private String text;
     ...
     * 图标底部文字默认颜色
     */
    private final int DEFAULT_TEXT_COLOR = 0x888888;
    /**
     * 图标绘制范围
     */
...
//        iconRect = new Rect(left, top, left + bitmapSide, top + bitmapSide);
        iconRect = new Rect(left+20, top+20, left + bitmapSide-20, top + bitmapSide-20);
    }
    ...
    private void drawSourceText(Canvas canvas, int alpha) {
        ...
        canvas.drawText(text, iconRect.left + iconRect.width() / 2 - textBound.width() / 2,
                iconRect.bottom + textBound.height()+20, textPaint);
    }
